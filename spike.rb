class Hero
	...
	def flee(monster)
		dice = []
		stealth.times { dice << 1 + rand(6) } #This is taking the empty dice array and adding 1 into it and adding a number between 1 and 6. This is figuring out the strength of the monster?
	...
	def attack(monster)
		dice = []
		strength.times { dice << 1 + rand(6) } #This is taking the empty dice array and adding 1 into it and adding a number between 1 and 6. This is figuring out the strength of the monster?
		successes = dice.count { |die| die > 4 }
